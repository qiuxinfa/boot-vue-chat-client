...
export default {
  ...
  data () {
    return {
			...
			chatObj:{username:'群聊',username:'群聊'},//群聊实体对象（为方法复用而构造，对于User对象）
			robotObj:{
				username:'机器人',
				username:'机器人',
			  avatar:'https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=2548892998,499717296&fm=26&gp=0.jpg'
			}
    }
  },
  computed: mapState([
